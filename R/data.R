...
#' A data frame with `r format(nrow(hubExamples::forecast_oracle_output), big.mark=",")`
#' rows and `r ncol(hubExamples::forecast_oracle_output)` columns:
#' \describe{
#'   \item{location}{FIPS code identifying a location}
...
#'   \item{oracle_value}{the predicted value that would be generated if the observed
#'         data were known with certainty in advance.}
#' }
#' @rdname forecast_data
"forecast_oracle_output"
